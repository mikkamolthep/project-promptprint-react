...
const Faqs = () => {
  return (
    <maim className="w-full min-h-screen  bg-gray-800 shadow-md rounded-lg flex flex-col justify-center items-center gap-1 max-md:mt-35">
      <header className="w-1/2 h-auto flex flex-col items-start gap-1 text-white max-md:w-full ">
        <h1 className="font-bold text-2xl">FAQ</h1>
        <p className="font-medium text-lg">How can we help you?</p>
      </header>
      <section className="w-1/2 h-160 bg-linear-to-t from-gray-800 to-purple-700 rounded-lg flex flex-col gap-2.5 justify-center items-center max-md:w-full">
        <div className="group w-[90%] h-23.75 bg-gray-100  rounded-lg flex flex-col justify-evenly shadow-md">
